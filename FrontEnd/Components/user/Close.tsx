                  ...
                  <FormControl sx={{ width: "100%" }}>
                    ...
                    <Controller
                      ...
                      render={({ field, formState: { errors } }) => (
                        ...
                        >
                          <MenuItem value={t("account.close.reasonOpt1")}>
                            {t("account.close.reasonOpt1")}
                          </MenuItem>
                          <MenuItem value={t("account.close.reasonOpt2")}>
                            {t("account.close.reasonOpt2")}
                          </MenuItem>
                          <MenuItem value={t("account.close.reasonOpt3")}>
                            {t("account.close.reasonOpt3")}
                          </MenuItem>
                          <MenuItem value={t("account.close.reasonOpt4")}>
